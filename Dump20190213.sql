...
CREATE TABLE `keyword` (
  ...
  `key_one` varchar(45) DEFAULT NULL,
  `key_two` varchar(45) DEFAULT NULL,
  `key_three` varchar(45) DEFAULT NULL,
  `key_four` varchar(45) DEFAULT NULL,
  `key_five` varchar(45) DEFAULT NULL,
...
INSERT INTO `keyword` VALUES (1,'Pain','Suffering','hatred','test',NULL);
